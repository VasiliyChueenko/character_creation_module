...
def defence(char_name: str, char_class: str) -> str:
    """Функция рассчета логики защиты."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция рассчета логики применения специальных умений."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция тренировки, определение потенциала персоонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция выбора класса персоонажа."""
    approve_choice: str = ''
    approve_choice = None
    char_class: str = ''
    char_class = None
